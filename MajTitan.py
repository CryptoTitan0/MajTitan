...
class MajTod:
    ...
    def log(self, msg):
        ...
        print(
            f"{black}[{now}]{white}-{blue}[{white}Subscribe Here https://youtube.com/@crypto_titan1 {self.p + 1}{blue}]{white} {msg}{reset}"
        )
...
async def main():
    ...
    worker = args.worker
    banner = f"""
{blue}████████╗██╗████████╗ █████╗ ███╗   ██╗{green}Automation for {yellow}Major
{blue}╚══██╔══╝██║╚══██╔══╝██╔══██╗████╗  ██║{white}Note : {green}Made by @Crypto_Titan0 
{blue}   ██║   ██║   ██║   ███████║██╔██╗ ██║{green}Note : {blue}Join Our Channel: https://t.me/Crypto_Titan0
{blue}   ██║   ██║   ██║   ██╔══██║██║╚██╗██║{green}Note : {red}Subscribe Here https://youtube.com/@crypto_titan1
{blue}   ██║   ██║   ██║   ██║  ██║██║ ╚████║
{blue}   ╚═╝   ╚═╝   ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝
    """
